...
switch (bankNameAccess) {
    case bank1Name: {
        console.log("Hey !! bhanu you are having the hdfc bank access");
        break;
    }
    case bank2Name: {
        console.log("Hey !! bhanu you are having the sbi bank access");
        break;
    }
    case bank3Name: {
        console.log("Hey !! bhanu you are having the icici bank access");
        break;
    }
    default: {
